...
function getCachedTags(cachedMetadata) {
  var _a, _b
  const bodyTags =
    ((_a = cachedMetadata.tags) === null || _a === void 0 ? void 0 : _a.map((x) => x.tag)) || []
  const frontMatterTags =
    ((_b = cachedMetadata.frontmatter) === null || _b === void 0 ? void 0 : _b.tags) || []
...
function append(target, node) {
  if (is_hydrating) {
    ...
    if (
      ...
      (target.actual_end_child !== null && target.actual_end_child.parentElement !== target)
    ) {
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      if (/*selectedTag*/ ctx[1] === void 0)
        add_render_callback(() => /*select_change_handler*/ ctx[4].call(select))
...
class SmartRandomNotePlugin extends obsidian.Plugin {
  constructor() {
    ...
    this.handleOpenTaggedRandomNote = () => {
      ...
      modal.submitCallback = (selectedTag) =>
        __awaiter(this, void 0, void 0, function* () {
    ...
    this.handleOpenRandomNoteFromSearch = () =>
      __awaiter(this, void 0, void 0, function* () {
        var _a
        const searchView =
          (_a = this.app.workspace.getLeavesOfType("search")[0]) === null || _a === void 0
            ? void 0
            : _a.view
        if (!searchView) {
    ...
    this.handleInsertLinkFromSearch = () =>
      __awaiter(this, void 0, void 0, function* () {
        var _b
        const searchView =
          (_b = this.app.workspace.getLeavesOfType("search")[0]) === null || _b === void 0
            ? void 0
            : _b.view
        if (!searchView) {
          new SmartRandomNoteNotice("The core search plugin is not enabled", 5000)
    ...
    this.openRandomNote = (files) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        yield this.app.workspace.openLinkText(
          fileToOpen.basename,
          "",
    ...
    this.insertRandomLinkAtCursor = (files) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const canEdit =
          viewState.type === "markdown" && viewState.state && viewState.state.mode == "source"
        if (!canEdit) {
          new SmartRandomNoteNotice(
            "Can't insert link. The active file is not a markdown file in edit mode.",
            5000,
          )
          return
        }
