...
function create_each_block_1(ctx) {
  ...
  function change_handler_1(...args) {
    return /*change_handler_1*/ ctx[12](
      /*item*/ ctx[25],
      /*each_value_1*/ ctx[28],
      /*i*/ ctx[27],
      ...args,
  ...
  function change_handler_2(...args) {
    return /*change_handler_2*/ ctx[13](
      /*item*/ ctx[25],
      /*each_value_1*/ ctx[28],
      /*i*/ ctx[27],
      ...args,
  ...
  function change_handler_3(...args) {
    return /*change_handler_3*/ ctx[14](
      /*item*/ ctx[25],
      /*each_value_1*/ ctx[28],
      /*i*/ ctx[27],
      ...args,
  ...
  return {
    ...
    p(new_ctx, dirty) {
      ...
      if (
        dirty & /*statusItems*/ 2 &&
        t0_value !== (t0_value = /*metricToString*/ ctx[3](/*item*/ ctx[25].metric) + "")
      )
      ...
      if (
        dirty & /*statusItems, MetricCounter*/ 2 &&
        select0_value_value !== (select0_value_value = /*item*/ ctx[25].metric.counter)
      ) {
        select_option(select0, /*item*/ ctx[25].metric.counter)
      }
      ...
      if (
        dirty & /*statusItems, MetricCounter*/ 2 &&
        select1_value_value !== (select1_value_value = /*item*/ ctx[25].metric.type)
      ) {
        select_option(select1, /*item*/ ctx[25].metric.type)
      }
      ...
      if (
        dirty & /*statusItems, MetricCounter*/ 2 &&
        input0_value_value !== (input0_value_value = /*item*/ ctx[25].prefix) &&
      ...
      if (
        dirty & /*statusItems, MetricCounter*/ 2 &&
        input1_value_value !== (input1_value_value = /*item*/ ctx[25].suffix) &&
...
function create_each_block(ctx) {
  ...
  function change_handler_4(...args) {
    return /*change_handler_4*/ ctx[20](
      /*item*/ ctx[25],
      /*each_value*/ ctx[26],
      /*i*/ ctx[27],
      ...args,
  ...
  function change_handler_5(...args) {
    return /*change_handler_5*/ ctx[21](
      /*item*/ ctx[25],
      /*each_value*/ ctx[26],
      /*i*/ ctx[27],
      ...args,
  ...
  function change_handler_6(...args) {
    return /*change_handler_6*/ ctx[22](
      /*item*/ ctx[25],
      /*each_value*/ ctx[26],
      /*i*/ ctx[27],
      ...args,
  ...
  function change_handler_7(...args) {
    return /*change_handler_7*/ ctx[23](
      /*item*/ ctx[25],
      /*each_value*/ ctx[26],
      /*i*/ ctx[27],
      ...args,
  ...
  return {
    ...
    p(new_ctx, dirty) {
      ...
      if (
        dirty & /*altSItems, MetricCounter*/ 4 &&
        select0_value_value !== (select0_value_value = /*item*/ ctx[25].metric.counter)
      ) {
        select_option(select0, /*item*/ ctx[25].metric.counter)
      }
...
function create_fragment$1(ctx) {
  ...
  return {
    ...
    p(ctx, [dirty]) {
      if (
        dirty &
        /*statusItems, update, plugin, MetricType, MetricCounter, swapStatusBarItems, metricToString*/ 27
      ) {
      ...
      if (
        dirty &
        /*altSItems, updateAlt, plugin, MetricType, MetricCounter, swapStatusBarItems, metricToString*/ 45
      ) {
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  const click_handler = async () =>
    $$invalidate(1, (statusItems = [...statusItems, JSON.parse(JSON.stringify(BLANK_SB_ITEM))]))
  ...
  const change_handler = async (item, each_value_1, i, e) => {
    ...
    $$invalidate(
      1,
      (each_value_1[i].metric.counter = MetricCounter[MetricCounter[value]]),
      statusItems,
    )
    await update(statusItems)
    await plugin.saveSettings()
  ...
  const click_handler_5 = async () =>
    $$invalidate(2, (altSItems = [...altSItems, JSON.parse(JSON.stringify(BLANK_SB_ITEM))]))
...
class BetterWordCountSettingsTab extends obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        "Reload required for change to take effect. The location of the vault statistics file, relative to the vault root.",
      )
      .addText((text) => {
...
const MATCH_HTML_COMMENT = new RegExp(
  "<!--[\\s\\S]*?(?:-->)?" +
    "<!---+>?" +
  ...
  async change(text) {
    ...
    if (
      ...
      const citations = Object.values(modFiles)
        .map((counts) => Math.max(0, counts.citations.current - counts.citations.initial))
        .reduce((a, b) => a + b, 0)
...
class StatusBar {
  constructor(statusBarEl, plugin) {
    ...
    this.plugin = plugin
    this.debounceStatusBarUpdate = obsidian.debounce(
      ...
      if (metric.counter === MetricCounter.words) {
        switch (metric.type) {
          ...
          case MetricType.daily:
            display =
              display +
              (this.plugin.settings.collectStats ? this.plugin.statsManager.getDailyWords() : 0)
            break
        ...
        switch (metric.type) {
          ...
          case MetricType.daily:
            display =
              display +
              (this.plugin.settings.collectStats ? this.plugin.statsManager.getDailySentences() : 0)
            break
          case MetricType.total:
            display =
              display +
        ...
        switch (metric.type) {
          ...
          case MetricType.daily:
            display =
              display +
              (this.plugin.settings.collectStats ? this.plugin.statsManager.getDailyFootnotes() : 0)
            break
          case MetricType.total:
            display =
              display +
        ...
        switch (metric.type) {
          ...
          case MetricType.daily:
            display =
              display +
              (this.plugin.settings.collectStats ? this.plugin.statsManager.getDailyCitations() : 0)
            break
          case MetricType.total:
            display =
              display +
        ...
        switch (metric.type) {
          ...
          case MetricType.daily:
            display =
              display +
              (this.plugin.settings.collectStats ? this.plugin.statsManager.getDailyPages() : 0)
            break
          case MetricType.total:
            display =
              display +
        ...
        switch (metric.type) {
          case MetricType.file:
            display =
              display +
              (this.plugin.settings.collectStats ? this.plugin.statsManager.getTotalFiles() : 0)
            break
          case MetricType.daily:
            display =
              display +
...
class SectionWordCountEditorPlugin {
  ...
  update(update) {
    ...
    if (update.docChanged) {
      ...
      update.changes.iterChanges((fromA, toA, fromB, toB, text) => {
        ...
        editEndLine = Math.max(
          editEndLine,
          spliceStart + (nextToLine.number - nextFromLine.number + 1),
        )
  ...
  mkDeco(view$1) {
    ...
    const getHeaderLevel = (line) => {
      ...
      if (
        /code-?block|math/.test(
          (_a = token === null || token === void 0 ? void 0 : token.type) === null || _a === void 0
            ? void 0
            : _a.name,
        )
      )
    ...
    if (!view$1.visibleRanges.length) return b.finish()
...
function getAllFilesInFolder(plugin, path) {
  ...
  return plugin.app.vault.getMarkdownFiles().filter((tFolder) => tFolder.path.startsWith(path))
}
...
function create_fragment(ctx) {
  ...
  return {
    ...
    p(new_ctx, [dirty]) {
      ctx = new_ctx
      if (dirty & /*file*/ 1 && t0_value !== (t0_value = /*file*/ ctx[0].name + ""))
        set_data(t0, t0_value)
...
class BetterWordCount extends obsidian.Plugin {
  ...
  onDisplaySectionCountsChange() {
    this.app.workspace.getLeavesOfType("markdown").forEach((leaf) => {
      if (
        (leaf === null || leaf === void 0 ? void 0 : leaf.view) instanceof obsidian.MarkdownView
      ) {
